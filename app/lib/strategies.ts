...
export const STRATEGIES: Strategy[] = [
  ...
  { name: "Padrão de Saída Órfã", nums: [0, 1, 2, 6, 9, 13, 14, 16, 17, 18, 20, 22, 25, 27, 31, 33, 34], color: "#f59e0b" },
  { name: "Padrão Exato/Disfarçados Juntos", nums: [0, 11, 14, 15, 16, 17, 18, 24, 25, 29, 30, 31, 32, 33, 34], color: "#22c55e" },
  { name: "Padrão Desenho", nums: [0, 1, 5, 9, 11, 12, 13, 14, 16, 19, 22, 23, 26, 27, 30, 32, 34], color: "#06b6d4" },
];
